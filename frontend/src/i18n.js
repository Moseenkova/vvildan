...
export const getMessages = (_) => ({
  ...
  submitted: _(msg`Form submitted!`),
  ...
  cancelRequest: _(msg`Cancel request`),
  reactivateRequest: _(msg`Reactivate request`),
  updatingRequest: _(msg`Updating...`),
  failedToUpdateRequest: _(msg`Could not update this request.`),
  close: _(msg`Close`),
